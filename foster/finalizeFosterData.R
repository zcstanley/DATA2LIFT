...
# Load data
# --------------------
load("foster/scrapedFosterData.Rdata")
load("foster/pumsData.Rdata")
load("foster/pumaShapes.Rdata")
...
# Save
save(fosterData, file = "foster/fosterData.Rdata")
...
ggsave(plot = p1, filename = "foster/fosterCountMap.png", width = 10, height = 6, units = "in", bg = "white")
...
# Save the plot as a PDF file
ggsave(plot = p2, filename = "foster/fosterDensityMap.png", width = 10, height = 6, units = "in", bg = "white")